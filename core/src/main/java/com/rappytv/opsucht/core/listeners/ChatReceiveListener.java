...
public class ChatReceiveListener {
  ...
  private static final Pattern SKULL_PATTERN = Pattern.compile(
      "^OPSUCHT » Du hast den Kopf von ([A-Za-z0-9_]{3,16}) erhalten\\.$");
  private static final Pattern DAILY_REWARD_PATTERN = Pattern.compile(
      "^OPSUCHT » Du hast deine tägliche Belohnung abgeholt und \\d+\\$ erhalten!$");
  ...
  private void replaceComponent(Component component, String target,
