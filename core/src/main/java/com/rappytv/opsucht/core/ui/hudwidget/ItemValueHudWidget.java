...
public class ItemValueHudWidget extends TextHudWidget<ItemValueHudWidgetConfig> {
  ...
  private static final Component NO_ITEM = Component.translatable(
      "opsucht.hudWidget.item_value.noItem");
  private static final Component NO_PRICE = Component.translatable(
      "opsucht.hudWidget.item_value.noPrice");
